<%@ Page Language="C#" MasterPageFile="~/Masterpager/MasterpagePublic.master" AutoEventWireup="true" CodeFile="giaotrinh.aspx.cs" Inherits="public_giaotrinh" Title="Giáo trình" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="left"> 
        <asp:Image ID="Image1" runat="server"  Width="75px" Height="75px" 
            ImageUrl='<%# Eval("HINHANH","~/Image/imagegiaotrinh/{0}") %>' />
