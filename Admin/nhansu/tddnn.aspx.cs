...
public partial class Admin_nhansu_tddnn : System.Web.UI.Page
{
    ...
    protected void ddlLiDoDi_SelectedIndexChanged(object sender, EventArgs e)
    {
        Lydoranuocngoia();
    }
    public void Lydoranuocngoia()
    {
        Lable6.Text = "Noi chi rưa";
        SqlParameter param = new SqlParameter("@IDLYDO", ddlLiDoDi.SelectedValue);
        GridView1.DataSource = dtsv.ExcuteTable("ns_Get_tt_dinuocngoai", param);
        GridView1.DataBind();
    }
}