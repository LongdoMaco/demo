<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpager/MasterPagesBasic.master" AutoEventWireup="true" CodeFile="cvdi.aspx.cs" Inherits="Admin_congvan_cvdi" %>
            ...
            <td colspan="6" style=" width:100%" >
                <asp:GridView ID="GridView1" runat="server" 
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:HyperLink ID="HyperLink2" runat="server" 
                                    NavigateUrl='<%# Eval("ID","~/Admin/congvan/chitietcvdi.aspx?IDDI={0}") %>' 
                        ...
                        <asp:BoundField DataField="Ngaybanhanh" HeaderText="Ban hành ngày" />
                        <asp:BoundField DataField="Sokyhieu" HeaderText="Số ký hiệu" />
                        ...
                        <asp:TemplateField HeaderText="Sửa">
                            <ItemTemplate>
                                <asp:HyperLink ID="HyperLink1" runat="server" 
                                    ...
                                    NavigateUrl='<%# Eval("ID","~/Admin/congvan/updatecvdi.aspx?IDDEN={0}") %>'>Sửa</asp:HyperLink>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
