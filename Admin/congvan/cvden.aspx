<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpager/MasterPagesBasic.master" AutoEventWireup="true" CodeFile="cvden.aspx.cs" Inherits="Admin_congvan_cvden" %>
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:HyperLink ID="HyperLink2" runat="server" 
                                    NavigateUrl='<%# Eval("ID","~/Admin/congvan/chitietcvden.aspx?IDDEN={0}") %>' 
                                    Text='<%# Eval("Trichyeunoidung") %>'></asp:HyperLink>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:BoundField DataField="denngay" HeaderText="Ngày đến" />
                        <asp:BoundField DataField="Sokyhieu" HeaderText="Số ký hiệu"  />
                       
                        <asp:BoundField DataField="banhanhngay" HeaderText="Ban hành ngày" />
                        <asp:BoundField DataField="Sokyhieu" HeaderText="Số ký hiệu" />
                        ...
                        <asp:TemplateField HeaderText="Sửa">
                            <ItemTemplate>
                                <asp:HyperLink ID="HyperLink1" runat="server" 
                                    NavigateUrl='<%# Eval("ID","~/Admin/congvan/updatecvden.aspx?IDDEN={0}") %>'>Sửa</asp:HyperLink>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
