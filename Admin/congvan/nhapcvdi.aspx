<%@ Page Title="Thêm công văn đến" Language="C#" MasterPageFile="~/Masterpager/MasterPagesBasic.master" AutoEventWireup="true" CodeFile="nhapcvdi.aspx.cs" Inherits="Admin_congvan_Nhapcvdi" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table class="style2">
        ...
        <tr>
            <td colspan="4"> 
                <asp:Button ID="btnGoiCV" runat="server" Text="Gởi công văn" Width="118px" 
