...
public partial class Admin_congvan_cvdenchuaxem : System.Web.UI.Page
{
    ...
    private void Initiazlie()
    {
        ...
        dtsv.FillDropDownListSQL(ddlLoaiCV, "select * from MaCongvandi", "MaCongvandi", "ID");
             
        dtsv.FillDropDownListSQL(ddlCQBH, "select * from BophanSoanthao", "TenBophan", "MaBophan");

        //Loai cong van den
        dtsv.FillDropDownListSQL(dlMacv, "select * from Loaicongvandi", "Tenloai", "Maloai");
        // tat ca cong van den

        dtsv.LoadGridView(GridView1, "sp_cvdichuaxem");
    ...
    {
        dtsv.LoadGridView(GridView1, "sp_cvdichuaxem_bpst", dtsv.CreateParameter("@bpst", ddlCQBH.SelectedValue));
    ...
    protected void btnXoa_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            for (int i = 0; i < GridView1.Rows.Count; i++)
            {
                ...
                if (cbitem.Checked)
                {
                    Label lb = (Label)GridView1.Rows[i].FindControl("Ma_CVDI_ND");
                    ...
                    tb = dtsv.ExecuteNonQuery("sp_cvdi_chuaxem_del", param);
                }
    ...
    protected void btnOK_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            dtsv.LoadGridView(GridView1, "Timtungaydigaychuaxem", param);
