<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpager/MasterPagesBasic.master" AutoEventWireup="true" CodeFile="chitietcvden.aspx.cs" Inherits="Admin_congvan_chitietcvden" %>
							...
							<td bgcolor="#f5f5f5" style="text-align: center">
								<div align="center">
									<table border="0" id="table11" cellspacing="0" cellpadding="0" width="100%">
										<tr>
											<TD style="WIDTH: 3.6%" height="240" rowspan="13"></TD>
										...
										<tr>
											<TD height="2" colspan="3" style="WIDTH: 546px; HEIGHT: 2px" class="style3">
											    <b><span class="style2">Chi tiết công văn đến</span><br />
                                                </b></TD>
										</tr>
										<tr>
											<TD height="2" colspan="3" style="WIDTH: 546px; HEIGHT: 2px" class="style8">
                                                ...
                                                <asp:HyperLink ID="HyperLink6" runat="server" 
                                                    NavigateUrl="~/Admin/congvan/cvden.aspx">Công văn đến</asp:HyperLink>
                                                </b></TD>
										</tr>
										<tr>
