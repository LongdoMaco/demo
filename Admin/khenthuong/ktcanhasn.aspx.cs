...
public partial class Admin_nhansu_in_khanttp : System.Web.UI.Page
{
    DataSet ds;
    ...
    {
        int IDDonVi = int.Parse(dlChuyende.SelectedValue);
    ...
    public void GetTen()
    {
        try
        {
            ...
            Label7.Text = dtsv.ExcuteScalary("ns_gethoten", param).ToString();
        }
        catch
        {
    ...
    {
        SqlParameter param=new SqlParameter ("@IDDONVI",dlChuyende.SelectedValue);
    ...
    protected void btnCapNhat_Click(object sender, EventArgs e)
    {
        ...
        {                                 
                    ...
                    SqlParameter[] param = new SqlParameter[]
                    {
                        ...
                        dtsv.CreateParameter("@QUYETDINHSO",txtquyetdinhso.Value),
                        dtsv.CreateParameter("@NGAYKY",txtngayky.Text),
                        dtsv.CreateParameter("NGUOIKY",txtnguoiky.Value),
    ...
    protected void lbtEdi_Click(object sender, EventArgs e)
    {
       ...
       try
        ...
        if(dt.Rows.Count!=0)
        {
            ...
            txtquyetdinhso.Value=dt.Rows[0]["QUYETDINHSO"].ToString();
            txtnoidung.Value=dt.Rows[0]["NOIDUNG"].ToString();
            txtnguoiky.Value=dt.Rows[0]["NGUOIKY"].ToString();
