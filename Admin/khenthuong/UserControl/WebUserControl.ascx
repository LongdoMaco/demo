...
<ul>
 <li><asp:HyperLink ID="HyperLink14" NavigateUrl="~/Admin/nhansu/timkiem.aspx" runat="server">Tìm kiếm</asp:HyperLink></li>
  <li>  <asp:HyperLink ID="HyperLink15" NavigateUrl="~/Admin/nhansu/thongke.aspx" runat="server">Thống kê</asp:HyperLink></li>
