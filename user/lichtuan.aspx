<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpager/MasterPageuser.master" AutoEventWireup="true" CodeFile="lichtuan.aspx.cs" Inherits="user_lichtuan" ValidateRequest="false"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table width="770" cellspacing="10" cellpadding="0" border="0" style="background-color: White;">
        <tbody>
            ...
            <tr>
                <td valign="top" align="left" style="border: 1px solid rgb(223, 223, 223); background-color: rgb(246, 246, 246);">
                    <table bgcolor="White" style="width: 100%;" cellspacing="10" class="auto-style6">
                        <tr>
                            <td style="height: 23px; width: 155px" class="auto-style2">Tuần:</td>
                        ...
                        <tr>
                            <td style="width: 155px" class="auto-style2">Thứ:</td>
                            <td>
                        ...
                        <tr>
                            <td style="width: 155px" class="auto-style2">Địa điểm:</td>
                            <td colspan="5">
                        ...
                        <tr>
                            <td style="width: 155px" class="auto-style2">Nội dung:</td>
                            <td colspan="5">
                        ...
                        <tr>
                            <td colspan="6">
                                <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False"
                                    BackColor="White" BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px"
                                    CellPadding="4" Width="100%" CssClass="auto-style6">
                                    <RowStyle BackColor="White" ForeColor="#330099" />
                                    <Columns>
                                        <asp:TemplateField Visible="false">
                                            <ItemTemplate>
