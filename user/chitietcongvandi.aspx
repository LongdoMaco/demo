<%@ Page Language="C#" MasterPageFile="~/Masterpager/MasterPageuser.master" AutoEventWireup="true" CodeFile="chitietcongvandi.aspx.cs" Inherits="user.congvan.user_chitietcongvan" Title="Untitled Page" %>
							...
							<td bgcolor="#f5f5f5" style="text-align: center">
								<div align="center">
									<table border="0" id="table11" cellspacing="0" cellpadding="0" width="100%">
										<tr>
											<TD style="WIDTH: 3.6%" height="240" rowspan="11"></TD>
											<TD align="right" height="2" colspan="3" 
                                                style="WIDTH: 546px; HEIGHT: 2px; text-align: left;">
											    <asp:Label ID="Label11" runat="server" style="font-weight: 700" 
                                                    Text="Chi Tiết Công Văn Đi"></asp:Label>
											</TD>
										</tr>
										<tr>
										...
										<tr>
											<TD style="WIDTH: 3.6%; height: 9px;">&nbsp;</TD>
											<TD style="WIDTH: 20.49%; height: 9px;" align="right" colspan="2">&nbsp;</TD>
											<TD vAlign="middle" style="WIDTH: 439px; height: 9px;">
