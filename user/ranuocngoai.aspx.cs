...
public partial class user_ranuocngoai : System.Web.UI.Page
{
    ...
    public void Get_ID_nuocngoai()
    {
        int manguoidung = Convert.ToInt32(Session["nguoisudung_ID"].ToString());
        SqlParameter param = new SqlParameter("@IDNV", manguoidung);
        GridView1.DataSource = dtsv.ExcuteTable("ns_Get_id_user_nuocngoai", param);
        GridView1.DataBind();
        SqlParameter parama = new SqlParameter("@IDNV", manguoidung);
        Lable6.Text = dtsv.ExcuteScalary("ns_gethoten", parama).ToString();
    }
    ...
    protected void btnThem_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            {
                    dtsv.CreateParameter("@IDTHONGTIN",iduser),
            ...
            if (ddlquocgia.Text != "")
                tb = dtsv.ExecuteNonQuery("ns_insert_nuocngoai_user", param);
            if (tb > 0)
    ...
    protected void bntCapNhat_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            tb = dtsv.ExecuteNonQuery("ns_update_NuocNgoai_user", param);
            if (tb > 0)
    ...
    protected void Button1_Click1(object sender, EventArgs e)
    {
        ...
        xuat = dtsv.ExcuteTable("ns_Get_id_user_nuocngoai", param);
        GridView1.DataSource = xuat;
        GridView1.DataBind();
