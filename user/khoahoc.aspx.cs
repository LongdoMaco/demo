...
public partial class user_KhoaHoc : System.Web.UI.Page
{
    ...
    {
        dtsv.LoadGridView(GridView1, "KH_THUYETMINH_Get_Theouser", dtsv.CreateParameter("@nguoisudungid", int.Parse(Session["nguoisudung_ID"].ToString())));
    }
    protected void btnthemmoi_Click(object sender, EventArgs e)
    {
            ...
            SqlParameter[] param = new SqlParameter[]
        {
            ...
            dtsv.CreateParameter("@TINHCAPTHIET",txtcapthiet.Value),
            dtsv.CreateParameter("@MUCTIEU",txtmuctieu.Value),
            dtsv.CreateParameter("@TRONGNGOAINUOC",txtketqua.Value)
        ...
        else Label5.Text = " Không Thành Công";
    ...
    protected void lbtsua_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (dt.Rows.Count != 0)
            {
                ...
                txtcapthiet.Value = dt.Rows[0]["TINHCAPTHIET"].ToString();
                txtmuctieu.Value = dt.Rows[0]["MUCTIEU"].ToString();
                txtketqua.Value = dt.Rows[0]["TRONGNGOAINUOC"].ToString();
