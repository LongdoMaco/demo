...
public partial class public_chitiettapchi : System.Web.UI.Page
{
    ...
    {
        ds = dtsv.ExcuteDataset("TapChi_Get_all_public_ID",dtsv.CreateParameter("@ID",int.Parse(Request.QueryString["MaSo"].ToString())));
        if(ds.Tables[0].Rows.Count!=0)
        {
            ...
            hinhanh.ImageUrl = "~/Image/imagetapchi/"+ds.Tables[0].Rows[0]["HINHANH"].ToString();
    ...
    protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
    {
        if (filename == "")
            return;
        Response.Redirect("~/Files/tapchi/"+filename);
    }
}
